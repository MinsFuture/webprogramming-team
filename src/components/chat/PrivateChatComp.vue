...
export default {
  ...
  methods: {
    ...
    getAllMessages() {
      return axios
        .get(
          `${this.$store.state.host}/message/private_channel/${this.channelId}`,
          {
            headers: {
              Accesstoken: this.$store.state.accessToken,
              "Content-Type": "application/json",
      ...
      this.stompClient = new Client({
        ...
        onConnect: () => {
          ...
          this.stompClient.subscribe(
            `/topic/chat/private/${this.channelId}`,
            (message) => {
              try {
    ...
    sendMessage() {
      ...
      this.stompClient.publish({
        destination: `/app/chat/private/${this.channelId}`,
